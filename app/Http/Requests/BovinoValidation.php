...
class BovinoValidation extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'tiene_identificador_oreja'   => ['required', 'boolean'],
            'tiene_identificador_lomo'    => ['required', 'boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'tiene_identificador_oreja.required' => 'Debe indicar si tiene identificador de oreja.',
            'tiene_identificador_oreja.boolean'  => 'El identificador de oreja debe ser verdadero o falso.',
            'tiene_identificador_lomo.required'  => 'Debe indicar si tiene identificador de lomo.',

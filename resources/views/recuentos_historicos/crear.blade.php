...
@section('content')
    ...
    <a class="btn btn-secondary mb-3" href="{{ route('recuentos-historicos.index') }}">
    ...
    <p>Importante: subir un archivo excel con las siguientes cinco columnas: <strong>Nro.</strong>, <strong>Carimbo</strong>, <strong>Identificador</strong>, <strong>Estado recuento</strong> y <strong>Fecha</strong>. El sistema validará que el formato sea correcto y que los datos correspondan a bovinos existentes en el sistema. En caso de encontrar errores, se indicará la fila y el motivo del error para su corrección.</p>
    ...
    <table class="table table-bordered table-striped" id="table-recuentos-historicos">
        <thead>
            <th>#</th>
            <th>Carimbo</th>
            <th>Identificador</th>
...
@section('scripts')
    @include('recuentos_historicos.crear_scripts')
@endsection

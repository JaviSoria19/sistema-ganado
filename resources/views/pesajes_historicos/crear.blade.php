...
@section('content')
    ...
    <a class="btn btn-secondary mb-3" href="{{ route('pesajes-historicos.index') }}">
    ...
    <p>Si se registra el pesaje más reciente de un bovino, su peso actual se actualizará automáticamente.</p>

    <table class="table table-bordered table-striped" id="table-pesajes-historicos">
        <thead>
            <th>#</th>
            <th>Carimbo</th>
            <th>Identificador</th>
...
@section('scripts')
    @include('pesajes_historicos.crear_scripts')
@endsection

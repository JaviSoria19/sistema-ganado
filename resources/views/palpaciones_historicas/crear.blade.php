...
@section('content')
    ...
    <p>Importante: subir un archivo excel con las siguientes columnas: <strong>Nro.</strong>, <strong>Carimbo</strong>, <strong>Identificador</strong>, <strong>Resultado</strong> y <strong>Fecha</strong>. El sistema validará que el formato sea correcto y que los datos correspondan a bovinos existentes en el sistema. En caso de encontrar errores, se indicará la fila y el motivo del error para su corrección.</p>

        ...
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modal-formulario-titulo">
                    <i class="fa-solid fa-duotone fa-plus"></i> CREAR PALPACIÓN HISTÓRICA
                </h1>
            ...
            <div class="modal-body">
                <form id="form-crear-o-editar">
                    ...
                    <input type="hidden" name="id_palpacion_historica" value="0">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="resultado" name="resultado" required>
                            ...
                            <option value="p">Preñada</option>
                            <option value="v">Vacía</option>
                        </select>
                    </div>
